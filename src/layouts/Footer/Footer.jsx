    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-contact">
          ...
          <p className="footer-item"> 805 S State St, Chicago, IL 60655-2222 </p>
        ...
        <div className="footer-social">
          ...
          <a className="footer-item" href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">Youtube</a>
        </div>
      </div>
    </footer>
  );
